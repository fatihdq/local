...
if __name__ == '__main__':
    for files in ALL_FILES:
        ...
        transform = FunctionsCrawlStoreShopee(files,PLATFORM,PLATFORM_ID)
        ...
        df_product = df_lookup[['product_id','product_name','predicted_brand','product_ctime','product_url','shop_id','platform']]
