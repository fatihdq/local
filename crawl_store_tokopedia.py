...
PATH = '{}/kalbe/store/tokopedia/2023-08-14'.format(DATA_PATH)
...
if __name__ == '__main__':
    for files in ALL_FILES:
        ...
        transform =  FunctionsCrawlStoreTokopedia(files,PLATFORM,PLATFORM_ID)
        ...
        if len(df_removed_null_category) != 0:
        ...
        df_lookup_product = transform.lookupProduct(df_lookup_category,df_mapping_product)
        df_lookup_pci= transform.lookupPci(df_lookup_product)
        df_lookup_brand = transform.lookupBrand(df_lookup_pci,db_mapping_brand)
        ...
        if len(df_category_removed_null) != 0:
        ...
        if len(df_sub_category_removed_null) != 0:
        ...
        if len(df_sub_sub_category_removed_null) != 0:
        ...
        df_product = df_lookup[['product_id','product_name','predicted_brand','product_url','shop_id','platform','subsubcat_id','segment','official_name','pci']]
        ...
        df_snapshot = df_lookup[['crawl_id','product_id','date','rank','page','price','price_before_discount','discount','item_sold','stock','view_count','rating_star','rating_count','star_1','star_2','star_3','star_4','star_5']]
