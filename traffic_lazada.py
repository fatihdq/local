...
"""
    ...
    and platform = 4
"""
PLATFORM = 'Lazada' ## Constant
PLATFORM_ID = 'LZ' ## Constant

LIST_STORE = ['twocare','rajasusu','levinmart','tokocleacleo','foodieshop']

START_DATE = '2024-05-16'
END_DATE = '2024-05-16'

PATH_LIST = ['Traffic Lazada/Daily 2024/5-May']
...
for STORE_LIXUS in LIST_STORE:
    for DATA_PATH in PATH_LIST:
        ...
        ALL_FILES = sorted(glob.glob(os.path.join(PATH, "*.xls")))
        ...
        for files in ALL_FILES:
            ...
            if START_DATE <= date_file and END_DATE >= date_file:
                ...
                transform_function = FunctionTrafficLazada(files, STORE_LIXUS,STORE_DOMAIN, STORE_CATEGORY, PLATFORM, PLATFORM_ID)
                ...
                df_traffic = df_lookup[['date','page_view','unique_visitor','unique_visitor_add_cart','add_cart','transaction','item_sold','gmv','product_id','variation_id','shop_id']]
