...
END_DATE = '2023-04-30'
DATA_PATH = 'Data Traffic_Order/Shopee/2023'
...
for files in ALL_FILES:
    ...
    if START_DATE <= date_file and END_DATE >= date_file:
        ...
        transform_function = FunctionTrafficBayininjaShopee(files, STORE_LIXUS,STORE_DOMAIN, STORE_CATEGORY, PLATFORM, PLATFORM_ID)
        df = pd.read_excel(files,sheet_name='Traffic Shopee',skiprows = skip_row(files,'Traffic Shopee'))
        if len(df) != 0:
