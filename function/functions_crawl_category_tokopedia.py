...
class FunctionsCrawlCategoryTokopedia(object):
    ...
    def basicTransform(self,df):
        ...
        renamed_columns = {'scraping_category':'crawling_category','scrapingtype':'crawling_type','filter_cat':'filter','region':'region','referer':'url','platform':'platform','timestamp':'date','rank':'rank','page_number':'page',
