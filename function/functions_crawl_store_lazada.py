...
class FunctionsCrawlStoreLazada(object):
    ...
    def basicTransform(self,df):
        dtype_mapping = {'crawling_category':'string','crawling_type':'string','filter':'string','region':'string','url':'string','platform':'string','date':'string','rank':'int','page':'int',
                'product_id':'string','product_name':'string','product_url':'string','sku':'string',
                'shop_id':'string','shop_name':'string','shop_domain':'string','location':'string','location':'string','shop_url':'string'}

        selected_columns = ['crawling_category','filter','crawling_type','region','platform','url','page','date','rank',
                'product_id','product_name','sku','product_url',
                'shop_id','shop_name','shop_domain','shop_url','location']
        renamed_columns = {'category_crawl':'crawling_category','keyword_store':'filter','scrapingtype':'crawling_type','region':'region','platform':'platform','referer':'url','page_number':'page','timestamp':'date','rank':'rank',
                'product_id':'product_id','product_name':'product_name','sku':'sku','product_url':'product_url',
                'shop_id':'shop_id','shop_name':'shop_name','shop_domain':'shop_domain','shop_url':'shop_url','location':'location',}
        ...
        df_null_value.loc[:,'predicted_brand'] = ''
