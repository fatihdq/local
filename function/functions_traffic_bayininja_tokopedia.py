...
class FunctionTrafficBayininjaTokopedia(object):
    ...
    def basicTransform(self,df):
        ...
        rename_column = {'Date':'date',
                                    ...
                                    'Pesanan':'transaction'}
        selected_columns = ['date','product_name', 'gmv', 'item_sold', 'page_view','transaction']
        dtype_mapping = {"date":"str","product_name":"str","page_view":"int","transaction":"int" ,"item_sold":"int","gmv":"int"}
        columns_str = ["product_name"]
        columns_int = ["page_view","transaction" ,"item_sold","gmv"]
