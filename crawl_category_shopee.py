...
PATH = '{}/sunfresh2/category/shopee/2023-01-18'.format(DATA_PATH)
...
if __name__ == '__main__':
    for files in ALL_FILES:
        ...
        transform = FunctionsCrawlCategoryShopee(files,PLATFORM,PLATFORM_ID)
        ...
        df_lookup_product = transform.lookupProduct(df_lookup_category,df_removed_duplicates_product)
        ...
        ## Insert shop
        df_shop = df_lookup[['shop_id','shop_name','shop_domain','shop_ctime','location','is_official','shop_url','platform']]
        ...
        df_product = df_lookup[['product_id','product_name','predicted_brand','product_ctime','product_url','subsubcat_id','shop_id','platform']]
        ...
        df_snapshot = df_lookup[['crawl_id','product_id','date','rank','page','price','price_before_discount','discount','item_sold','stock','rating_star','rating_count','star_1','star_2','star_3','star_4','star_5']]
